...
//设置信息
var _conf = {
    Domain: 'shixunfang.10knet.com',
    SvrPort: 8000,
    Domains: ['shixunfang.10knet.com'],
    Qiniu: Object.assign({
        BucketName: "file10knet",
        BucketDomain: "http://file.10knet.com",
...
_conf.regx = {
    ...
    avatar: /^(http)?(s)?(:)?\/\/file\.10knet.com\/[\S\s]{3,256}$/, //头像，必须来自app.10knet网站，以便于裁切
    ...
    title: /^[\S\s]{1,128}$/, //标题，任意字符
    text: /^[\S\s]{0,1024}$/, //内容，任意字符
    text256:/^[\S\s]{0,256}$/, //内容，任意字符
};
