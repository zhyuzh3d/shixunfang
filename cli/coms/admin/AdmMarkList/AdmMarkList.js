...
async function getItemArr() {
    ...
    var data = {
        ...
        cmd: 'models.mark.find({},"state pass comment").populate({path:"check",select:"title author task",populate:[{path:"author",select:"name"},{path:"task",select:"title"}]}).populate("author","name").sort({created_at:-1})',
    };
